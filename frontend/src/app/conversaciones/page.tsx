  ...
  return (
    <div>
      ...
      <div className="flex gap-5" style={{ height: 'calc(100vh - 180px)' }}>
            ...
            <div className="flex gap-1 mt-3">
              {[3, 7, 14, 30].map((d) => (
                <button
                  ...
                  onClick={() => setDias(d)}
                  style={{
                    flex: 1, padding: '5px 0', borderRadius: 8, fontSize: 12, border: 'none', cursor: 'pointer',
                    background: dias === d ? 'var(--color-primary)' : 'transparent',
                    color: dias === d ? '#faf6f1' : 'var(--color-text-muted)',
          ...
          <div style={{ flex: 1, overflowY: 'auto' }}>
            {loading ? (
              ...
              <div className="p-6 text-center">
                <MessageSquare size={32} style={{ color: '#d4c4b0', margin: '0 auto 8px' }} />
                ...
                >
                  <div className="flex items-start gap-3">
                    <div
                      ...
                      style={{ background: 'linear-gradient(145deg, #c2614b, #d4a574)', color: '#faf6f1' }}
                    >
                      {c.telefono.slice(-2)}
                    </div>
                    <div style={{ flex: 1, minWidth: 0 }}>
                      ...
                      <span className="inline-block mt-1 px-1.5 py-0.5 rounded text-xs" style={{ background: '#f5efe8', color: 'var(--color-primary)', fontWeight: 600 }}>
                        {c.mensajes} msgs
                      </span>
                    </div>
                  </div>
        ...
        {/* Chat panel */}
        <div className="card flex flex-col flex-1" style={{ overflow: 'hidden' }}>
          {!seleccionado ? (
            <div className="flex-1 flex flex-col items-center justify-center" style={{ color: 'var(--color-text-muted)' }}>
              <MessageSquare size={48} style={{ color: '#d4c4b0', marginBottom: 12 }} />
              <p className="font-semibold">Selecciona una conversacion</p>
            ...
            <>
              ...
              {/* Messages */}
              <div style={{ flex: 1, overflowY: 'auto', padding: '20px', background: 'var(--color-surface)' }}>
                {loadingMsgs ? (
